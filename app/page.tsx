...
export default function FinyraLanding() {
  ...
  const faqData = [
    {
      question: "What is Stonka?",
      answer:
        "Stonka is a revolutionary platform that uses artificial intelligence to help developers build mobile applications faster and more efficiently. Our AI understands your requirements and generates optimized, production-ready code.",
    },
    {
    ...
    {
      question: "What platforms does Stonka support?",
      answer:
        "Stonka supports all major mobile development frameworks including React Native, Flutter, Swift (iOS), and Kotlin (Android). We also provide cross-platform solutions for maximum compatibility.",
    },
    {
    ...
    {
      question: "How much does Stonka cost?",
      answer:
    ...
    {
      question: "Can I integrate Stonka with my existing development workflow?",
      answer:
        "Yes! Stonka seamlessly integrates with popular development tools like GitHub, GitLab, VS Code, and CI/CD pipelines. You can incorporate our AI assistance into your existing workflow without disruption.",
    },
    {
    ...
    {
      question: "How do I get started with Stonka?",
      answer:
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 lg:px-12 xl:px-16 max-w-7xl mx-auto relative">
        ...
        <div className="relative">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-slate-300 text-lg md:text-xl max-w-3xl mx-auto animate-text-fade-in">
              Everything you need to know about Stonka
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 lg:px-12 xl:px-16 max-w-7xl mx-auto relative">
        ...
        <div className="relative">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-slate-300 text-lg md:text-xl max-w-3xl mx-auto animate-text-fade-in">
              We're here to help you succeed with Stonka
            </p>
          </div>
